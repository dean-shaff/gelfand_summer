from pwn_model_tools import Output
from pwn_model_tools import Observables
import numpy as np 
...
def neglikelihood(theta,directory): 
	...
	It creates a log file that contains the parameters used for each run of the mcmc model routine, as well as the value of the likelihood with those parameters.
	The directory parameter specifies where to dump the log and fits files generated by the c++ code. 
	'''
	data = [d, radio1, radio2, radio3, radio4, fluxsoftx, 
	gammasoftx, fluxhardx, gammahardx, gammagamma, gamma1] 
	dataerror = [dsigma, radio1sigma, radio2sigma, radio3sigma, 
...
"""
below are the best fit parameters that I've been able to find. They minimize the likelihood function. 
"""
